...
prefix="c"%> <%@ taglib uri="http://tiles.apache.org/tags-tiles"
prefix="tiles"%>
      ...
      <div class="container-fluid">
        <form id="Form1" method="post" action="Find">
          ...
          <div class="row">
            ...
            <div class="col-xs-8">
              <input name="性別" type="radio" value="1" /><span>男</span>
              <input name="性別" type="radio" value="2" /><span>女</span>
            </div>
          </div>
